...
class PDFReportGenerator:
    ...
    def generate_report(self, scan_results):
        ...
        filename = f"web_doc_scan_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf"
    ...
    def _create_cover_page(self, results):
        ...
        # Title
        title = Paragraph("WEB DOC SECURITY ASSESSMENT REPORT", self.title_style)
        elements.append(title)
        elements.append(Spacer(1, 0.5*inch))
        
        # Report generated by
        generated_by = Paragraph("Generated by: Web Doc Vulnerability Scanner", self.styles['Normal'])
